...
class MetaTagSorterAlphabeticalTest {
	...
	private static Stream<Arguments> provideTestCodings() {
		return Stream.of(
			...
			Arguments.of(
				//the description of the test case
				named("null system is less than non-null code",
					// the Input
	...
	public void testSortCodings(List<Coding> theInput, List<Coding> theExpected) {
		...
		assertCodingsEqual(theExpected, toBeSorted);
	}
	...
	public void testSortPrimitiveStringTypes(List<String> theInput,
														  List<String> theExpected) {
	...
	public void testSort() {
		...
		assertCodingsEqual(expectedCoding, meta.getTag());
		assertCodingsEqual(expectedCoding, meta.getSecurity());
